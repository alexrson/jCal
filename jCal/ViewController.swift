...
class ViewController: UIViewController {
    ...
    @IBAction func showMessage() {
        ...
        println(today_french_date)
        println(today_french_date2)
        ...
        let alertController = UIAlertController(title:today_french_date, message:today_name, preferredStyle: UIAlertControllerStyle.Alert)
